...
namespace GodotSharp.BuildingBlocks
{
    public static class SettingsExtensions
    {
        ...
        public static T TryGet<[MustBeVariant] T>(this Settings source, Node key, T @default) => source.TryGet("", key.Name, @default);
        public static T TryGet<[MustBeVariant] T>(this Settings source, Node section, Node key, T @default) => source.TryGet(section.Name, key.Name, @default);
    }
}
